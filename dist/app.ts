  ...
  implements Draggable
{
  ...
  dragStartHandler(event: DragEvent) {
    event.dataTransfer!.setData("text/plaint", this.project.id);
  ...
  implements DragTarget
{
  ...
  dragOverHandler(event: DragEvent) {
    if (event.dataTransfer && event.dataTransfer.types[0] === "text/plaint") {
  ...
  dropHandler(event: DragEvent) {
    const prjId = event.dataTransfer!.getData("text/plaint");
